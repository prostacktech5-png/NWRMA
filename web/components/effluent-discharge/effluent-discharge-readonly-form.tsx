...
export function EffluentDischargeReadonlyForm({ application }: { application: EffluentDischargeApplication }) {
    ...
    >
      ...
      <FormSection title="4.0 Type of effluent generated">
        <PortalReadonlyField
            ...
            value={[...form.effluentGeneratedTypes, form.effluentGeneratedTypesOther]
              .filter(Boolean)
              .join(', ')}
          />
      </FormSection>
      ...
      <FormSection title="8.0–9.0 Affected parties & environment">
          ...
          <PortalReadonlyField
            ...
            highlightIfEmpty
          />
          <PortalReadonlyField label="Abstraction / pump details" value={form.abstractionPumpDetails} className="nwrma-field--full" />
      </FormSection>
                    ...
                    <ul className="mt-2 space-y-2">
                      {files.map((file, fileIndex) => (
                        ...
                        >
                          ...
                          <EffluentDischargeDocumentActions
