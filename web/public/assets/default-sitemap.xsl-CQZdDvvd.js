const t="NWRMA",n=`<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet
	version="2.0"
...
>
	...
	<a href="https://nwrma.gov.sl"><span>Home</span></a>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on May 19, 2026 at 9:45 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="https://nwrma.gov.sl"><span>Home</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://nwrma.gov.sl" class="button">Back to Homepage</a>
					</div>
...
</xsl:stylesheet>`,e={title:t,html:n};export{e as default,n as html,t as title};
